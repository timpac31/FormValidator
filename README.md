 ...
 * **valid-rule**
   ...
   * 구분자 | 를 사용하여 하나의 element에 여러개의 룰을 설정할 수 있습니다. 예) valid-rule="required|maxLength-10|onlyNum"
   * rule- 뒤에 나오는 값으로 파라미터를 설정합니다. 예) valid-rule="between-2-5"  //숫자 2~5사이의 값만 허용
<br/>
